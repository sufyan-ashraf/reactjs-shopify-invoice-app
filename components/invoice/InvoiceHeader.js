...
export default function InvoiceHeader({ className, status, setPopupIsOpen, setFormIsOpen, handlePaid, handlePrintInvoice }) {
    return (
        <Wrapper className={className}>
            <Status>Status</Status>
            <InvoiceStatus status={status}/>
            <Buttons>
            <Button secondary onClick={() => handlePrintInvoice()}>Print</Button>
